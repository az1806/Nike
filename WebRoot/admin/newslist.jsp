    ...
    <![endif]-->
 	 ...
 	 <script type="text/javascript">
 		function addnews(){
 			...
 			if(ncon!="" && type!="" ){
 				window.location.href="admin/newslist?method=addNews&ncon="+encodeURI(encodeURI(ncon))+"&type="+encodeURI(encodeURI(type));
 			}
        ...
        <%for(int i=0;i<nes.size();i++){ %>
          <tr>
            ...
            <td class="td-manage">
              ...
              <a title="删除" onclick="member_del(this,'要删除的id')" href="admin/newslist?method=deletNews&news_Id=<%=nes.get(i).getNews_Id()%>">
                <i class="layui-icon">&#xe640;</i>
              </a>
            </td>
          </tr>
