...
<%
	...
	String basePath = request.getScheme() + "://"
			...
			+ path + "/";
	 Producttype pro = (Producttype) request.getAttribute("ptlist");
%>
...
<script type="text/javascript">
	function update() {
		...
		window.location.href = "admin/productcate?method=updatesProducttype&tName="
