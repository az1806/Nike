...
<%
	...
	String basePath = request.getScheme() + "://"
			...
			+ path + "/";
	Message mes = (Message)request.getAttribute("mlist");
%>
...
<script type="text/javascript">
	function update() {
		...
		window.location.href = "admin/messagelist?method=updateMessage&mstate="
				+ encodeURI(encodeURI(mstate))
				+"&id=<%=mes.getId()%>";
	}
</script>
</head>
		...
		<form class="layui-form">
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="mstate" name="mstate" required=""
